...
namespace {
    ...
    const int NUMBER_OF_THREADS = support::json_utils::read_data("../antivirus/AppData/user_settings.json")[
        "Number of threads"];
} // namespace
...
int main(int argc, char *argv[]) {
    ...
    try {
        ...
        std::cout << "Files with detected virus" << std::endl;
        for (const auto& file_data : results) {
            std::cout << file_data.first << std::endl;
        }
